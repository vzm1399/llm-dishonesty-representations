...
# نصب پکیج‌ها به صورت جداگانه (بهتر برای flash-attn)
subprocess.run([sys.executable, "-m", "pip", "install", "-q",
    "transformers==4.45.0", "datasets", "peft==0.11.1", "accelerate", 
    "bitsandbytes", "scikit-learn", "matplotlib", "numpy==1.26.4"], check=True)

# نصب جداگانه flash-attn
...
CONFIG = {
    ...
    "results_dir": "./results_gemma2_2b_strong",
    "mmlu_subjects": [
...
def build_lora_model():
    ...
    base = AutoModelForCausalLM.from_pretrained(
        ...
        attn_implementation="eager",   # برای Gemma-2-2B بهتر است
    )
