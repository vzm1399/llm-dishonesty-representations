...
import os; login(token=os.environ.get('HF_TOKEN'), add_to_git_credential=False)

subprocess.run([sys.executable, "-m", "pip", "install", "-q",
    "transformers==4.45.0", "datasets", "peft==0.11.1", "accelerate", "bitsandbytes",
    "scikit-learn", "matplotlib", "numpy==1.26.4", "flash-attn --no-build-isolation"], check=True)
...
CONFIG = {
    ...
    "max_samples": 500,           # قابل تنظیم
    "mmlu_samples": 300,
    "finetune_epochs": 3,
    "lr": 1e-5,
    "batch_size": 1,              # برای RTX 3090
    "max_length": 384,
    "probe_cv_folds": 5,
    "seed": 42,
    "lora_r": 32,
    ...
    "mmlu_subjects": [
        ...
        "philosophy", "elementary_mathematics", "college_mathematics"
    ],
